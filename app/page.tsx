...
const trends: TrendPrompt[] = [
  {
    ...
    category: 'image',
    image: 'portrait',
    imageAlt: 'Devotee-style Meenakshi Amman temple kumbabishekam celebration portrait concept',
