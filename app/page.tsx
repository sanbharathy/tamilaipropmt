...
const popularSearches = [
  ...
  'Meenakshi kumbabishekam AI prompt',
];
...
const trendVisualThemes: Record<number, { bg: string; accent: string; sceneTa: string; sceneEn: string }> = {
  63: { bg: '#7c2d12', accent: '#facc15', sceneTa: 'Kumbabishekam', sceneEn: 'Kumbabishekam' },
...
const trends: TrendPrompt[] = [
  {
    ...
    category: 'image',
    image: 'portrait',
    imageAlt: 'Photorealistic devotee at Meenakshi Amman temple kumbabishekam celebration',
    titleTa: 'Meenakshi Kumbabishekam Portrait',
    titleEn: 'Meenakshi kumbabishekam portrait',
    descriptionTa: 'இன்றைய மதுரை மீனாட்சி அம்மன் கும்பாபிஷேக vibe-ல் உங்கள் photo-வை பக்தி celebration portrait ஆக மாற்றுங்கள்.',
    descriptionEn: 'Place your photo into a respectful Madurai Meenakshi Amman kumbabishekam celebration-style portrait.',
    prompt:
      'Draft 1 — Real photo standing in celebration: நான் upload செய்யும் என் portrait photo-வை accurate face reference ஆக பயன்படுத்தவும். மதுரை மீனாட்சி அம்மன் கோவில் மகா கும்பாபிஷேகம் celebration vibe-ல், கோவில் கோபுரம் தொலைவில் தெரியும் வெளிப்புற பகுதியில் நான் பக்தர்களுடன் மரியாதையாக நிற்பது போல ultra realistic real camera photo உருவாக்கவும். Documentary photography, natural skin texture, realistic hands, real saree/veshti fabric detail, festive crowd softly blurred, மஞ்சள்-குங்கும நிறங்கள், temple flags, flower petals, soft morning golden light, spiritual celebration mood, no cartoon, no illustration, no plastic AI skin, no deity face recreation, no inside-sanctum scene, no real crowd face copying. கீழ்-வலது மூலையில் “tamilaiprompt.com” watermark சேர்க்கவும்.\n\nDraft 2 — Real photo getting blessing: நான் upload செய்யும் photo-வை identity reference ஆக கொண்டு, கோவில் வெளிப்புற விழா சூழலில் ஆசீர்வாதம் பெறும் பக்தர் போல் real candid photo உருவாக்கவும். Sacred water sprinkle atmosphere, flower petals, priests only as respectful distant silhouettes, crowd blurred, Meenakshi temple gopuram background, calm devotional expression, documentary realism, natural skin texture, real lens depth of field, no political symbols, no misleading real-news claim, no illustration. “tamilaiprompt.com” watermark bottom-right.\n\nDraft 3 — Real festival thumbnail photo: என் uploaded portrait-ஐ வைத்து Madurai festival social-media thumbnail போல photorealistic camera photo உருவாக்கவும்: golden gopuram lights, kolam pattern foreground, garland colors, warm cinematic glow, respectful Tamil devotional celebration mood, premium Instagram/YouTube thumbnail composition, identity unchanged, realistic lighting and shadows, no random text, no cartoon or poster art. “tamilaiprompt.com” watermark bottom-right.',
    models: ['Gemini', 'ChatGPT Images', 'Midjourney'],
    updatedTa: 'இன்றைய ட்ரெண்ட்',
    updatedEn: "Today's trend",
    featured: true,
    needsPhoto: true,
  },
  {
...
const englishPromptById: Record<number, string> = {
  63: `Draft 1 — Real photo standing in celebration: Use my uploaded portrait photo as an accurate face reference. Create an ultra realistic real camera photo where I am respectfully standing with devotees in an outdoor Madurai Meenakshi Amman Temple maha kumbabishekam celebration atmosphere. Show the temple gopuram in the distance, festive crowd softly blurred, turmeric and kumkum color palette, temple flags, flower petals, soft morning golden light, spiritual celebration mood, natural face identity, natural skin texture, realistic hands, real saree/veshti fabric detail, no cartoon, no illustration, no plastic AI skin, no deity face recreation, no inside-sanctum scene, and no copying of real crowd faces. Add “tamilaiprompt.com” as a bottom-right watermark.

Draft 2 — Real photo getting blessing: Use my uploaded photo as the identity reference and place me as a devotee receiving blessings in an outdoor festival setting. Make it look like a candid documentary photograph with sacred-water-sprinkle atmosphere, flower petals, priests only as respectful distant silhouettes, softly blurred devotees, Meenakshi temple gopuram background, calm devotional expression, natural skin texture, real lens depth of field, no political symbols, no misleading real-news claim, and no illustration style. Add “tamilaiprompt.com” as a bottom-right watermark.

Draft 3 — Real festival thumbnail photo: Use my uploaded portrait to create a photorealistic Madurai festival social-media thumbnail photo: golden gopuram lights, kolam pattern foreground, garland colors, warm cinematic glow, Tamil devotional celebration mood, premium Instagram/YouTube thumbnail composition, identity unchanged, realistic lighting and shadows, no random text, no cartoon, and no poster art. Add “tamilaiprompt.com” as a bottom-right watermark.`,
